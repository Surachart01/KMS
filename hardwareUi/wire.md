...
```
Pin  1 (3.3V)  ── NFC VCC / I2C VCC (shared)
Pin  2 (5V)    ── Relay VCC / I2C VCC (5V module)
Pin  3 (GPIO2) ── I2C SDA  ⚡ (เปลี่ยนจาก NFC RST)
Pin  5 (GPIO3) ── I2C SCL
Pin  6 (GND)   ── NFC GND / I2C GND (shared)
...
Pin 25 (GPIO7) ── NFC RST (shared) ⚡ ย้ายจาก Pin 3
...
**Pin ที่ว่าง:** 4, 14, 17, 20, 24, 26, 28, 30, 34, 39 (GPIO 1, 8 เท่านั้น)
