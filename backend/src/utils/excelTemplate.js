...
export function generateStudentTemplate() {
    ...
    const templateData = [
        ...
        ['รหัสนักศึกษา*', 'ชื่อ*', 'นามสกุล*', 'อีเมล*', 'สาขาวิชา*', 'กลุ่มเรียน'],
        // Example row
        ['67-020415-1001-6', 'สมชาย', 'ใจดี', '[email protected]', 'วิศวกรรมคอมพิวเตอร์', '1/1'],
        ['67-020415-1002-4', 'สมหญิง', 'รักเรียน', '[email protected]', 'วิศวกรรมคอมพิวเตอร์', '1/1'],
    ...
    const instructionsData = [
        ...
        ['   - แนะนำใช้อีเมลมหาวิทยาลัย'],
        [''],
        ['4. สาขาวิชา:'],
        ['   - ต้องมีอยู่ในระบบแล้ว'],
        ['   - ดูรายชื่อสาขาได้ใน Sheet "สาขาวิชา"'],
        [''],
        ['5. กลุ่มเรียน (Optional):'],
        ['   - ถ้าไม่ระบุจะไม่มีกลุ่มเรียน'],
        ['   - ถ้าระบุต้องเป็นกลุ่มที่มีอยู่ในสาขาวิชานั้น'],
        [''],
        ['6. รหัสผ่าน:'],
        ['   - ระบบจะสร้างรหัสผ่านเริ่มต้นโดยอัตโนมัติ (รหัสนักศึกษา)'],
        ['   - นักศึกษาควรเปลี่ยนรหัสผ่านหลังเข้าใช้งานครั้งแรก'],
        [''],
        ['7. วิธีการ Import:'],
