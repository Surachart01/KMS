...
export default function DailyBookingGenerator() {
    ...
    useEffect(() => {
        // Always set to today on mount, and reload if needed. 
        // Though useState(dayjs()) already sets it.
        if (selectedDate) {
            fetchBookings();
        }
    }, [selectedDate]);
                    ...
                    <Row gutter={[16, 16]} align="middle">
                        <Col xs={24} md={8}>
                            <Space direction="vertical" style={{ width: "100%" }}>
                                ...
                                <DatePicker
                                    value={selectedDate}
                                    disabled={true} // Disabled to enforce today only
