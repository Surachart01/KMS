...
export default function MajorsPage() {
    ...
    const handleSubmit = async (values) => {
        try {
            if (editingMajor) {
                await majorsAPI.update(editingMajor.major_id, values);
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "sections_count",
            render: (_, record) => record._count?.sections || 0,
            width: 150,
        },
        {
            ...
            render: (_, record) => (
                <Space size="small">
                    ...
                    <Popconfirm
                        ...
                        onConfirm={() => handleDelete(record.major_id)}
                        okText="ใช่"
                        cancelText="ไม่"
                    >
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    >
                        <Input placeholder="เช่น คอมพิวเตอร์ศึกษา" />
                    </Form.Item>
                </Form>
            </Modal>
        </div>
